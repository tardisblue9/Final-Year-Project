...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc_class_1 = nn.Linear(self.hidden_dim*2, 84)
    ...
    def forward(self, x):
        h0 = torch.zeros(self.num_layers*2, self.batch_size, self.hidden_dim) # x2 for bidirectional
        c0 = torch.zeros(self.num_layers*2, self.batch_size, self.hidden_dim)
...
save_fig(logbook_epoch, "/Users/vanellope/Desktop/FYP/Plot归档/embedBert_RNN_bi1way_100_lr{}_epoch{}.jpg".format(learning_rate,epoch_number))
