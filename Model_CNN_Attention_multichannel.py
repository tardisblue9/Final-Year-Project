...
class Net(nn.Module):
    def __init__(self):
        ...
        self.art_dim = self.channel_num*6
        self.fc_art_1 = nn.Linear(self.art_dim, 192)
        self.fc_art_2 = nn.Linear(192, 1)

        self.fc_class_1 = nn.Linear(self.art_dim, 120)
...
#         print("sentence number:",len(x))
        ...
        for x_sent in x:
            try:
                ...
                x_combine = torch.cat([temp_x_sent1_1,temp_x_sent1_2,temp_x_sent1_3,temp_x_sent2_1,temp_x_sent2_2,temp_x_sent2_3], 1) # stack
                temp_x.append(x_combine)
        ...
        x = torch.mul(x, w_art)
        x = torch.mean(x, 2, True)  # art_dimx1
...
save_fig(logbook_epoch, "/Users/vanellope/Desktop/FYP/Plot归档/embedBert&Static_level2_CNN_attention_2_5_8_150c_900_lr{}_epoch{}.jpg".format(learning_rate,epoch_number))
